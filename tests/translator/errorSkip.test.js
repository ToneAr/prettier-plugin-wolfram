  ...
  it('skips formatting when the CST contains parser error nodes', async () => {
    ...
    getCST.mockResolvedValue({
      ...
      children: [
        ...
        { type: 'LeafNode', kind: 'Token`Whitespace', value: ' ', source: [[1, 2], [1, 3]] },
        { type: 'LeafNode', kind: 'Token`Plus', value: '+', source: [[1, 3], [1, 4]] },
        { type: 'LeafNode', kind: 'Token`Newline', value: '\n', source: [[1, 4], [2, 1]] },
        { type: 'LeafNode', kind: 'Token`Whitespace', value: '  ', source: [[2, 1], [2, 3]] },
        {
          type: 'Unknown',
