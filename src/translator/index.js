  ...
  switch (node.type) {
    case 'ContainerNode':
      return printContainer(node, options, (child) => {
        return path.call(print, 'children', node.children.indexOf(child));
      });
    ...
    case 'InfixNode':
      return printInfix(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));

    case 'BinaryNode':
      return printBinary(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));

    case 'PrefixNode':
      return printPrefix(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));

    case 'PostfixNode':
      return printPostfix(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));

    case 'CompoundNode':
      return printCompound(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));
    ...
    case 'TernaryNode':
      return printTernary(node, options,
        (child) => path.call(print, 'children', node.children.indexOf(child)));
